...
Ha jóváhagytam, használd a \`contract_status_create\` eszközt egyenként (vagy párhuzamosan), hogy létrehozd az összes fázist mint új belső státuszt a rendszeremben. Add át a nevet, szint és ikont a végpontnak.`
  ...
  server.prompt(
    "branding-beallitasa",
    `Egyedi arculat (branding) beállítása: logók, színek és stílusok proaktív testreszabása és aktiválása. Használd amikor a felhasználó meg akarja változtatni a szerződések vagy e-mailek kinézetét, vagy egy weboldal alapján kéri az arculat beállítását.`,
    {},
    () => ({
      messages: [
        {
