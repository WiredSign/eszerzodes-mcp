...
export function registerMonitoringTools(
    ...
    server.tool(
        ...
        `Lists pending contracts and optionally resends invitations for those that have been waiting for a certain number of days.
...
Use this when the user wants to monitor their signing processes, identify 'stuck' contracts, or send automated reminders.`,
        ...
        async (params) => {
            ...
            const result: any = await client.get("/agent/contracts", { page: "1" });
            ...
            for (const contract of contracts) {
                ...
                if (contract.finalized_at && contract.finalized_at !== "") continue;
